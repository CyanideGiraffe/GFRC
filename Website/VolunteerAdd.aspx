<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VolunteerAdd.aspx.cs" Inherits="VolunteerAdd" Theme="Main"%>
    ...
    <div id="container">
        ...
        <div id="content">
            <div id="left">
                ...
                <a href="VolunteerAdd.aspx" class="selected">Add New</a>
            </div>

            <div id="right">
                <form id="addVol" visible="true" runat="server">
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2" class="error">
                                ...
                                <asp:RegularExpressionValidator ID="rgxDOB" ControlToValidate="txtDOB" Text="Please enter a date of birth" ValidationExpression="^[0-3]?\d/[0-1]?\d/\d{4}$" Display="Dynamic" runat="server" />
                        ...
                        <tr>
                            <td colspan="2" class="button"><asp:Button ID="btnAddVolunteer" Text="Add" OnClick="btnAddVolunteer_Click" runat="server" /></td>
                        </tr>
                    </table>
                </form>
            </div>
