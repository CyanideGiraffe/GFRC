<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminList.aspx.cs" Inherits="AdminList" Theme="Main"%>
...
<body>
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="right">
                <form id="list_logins" runat="server">
                    <asp:PlaceHolder ID="logins" runat="server"></asp:PlaceHolder>
                </form>
            </div>
